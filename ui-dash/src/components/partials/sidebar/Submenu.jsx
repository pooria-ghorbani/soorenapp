...
const Submenu = ({ activeSubmenu, item, i }) => {
  ...
  return (
    <Collapse isOpened={activeSubmenu === i}>
      <ul className="sub-menu  space-y-4  mr-4">
            ...
            {subItem?.multi_menu ? (
              <div>
                <div
                  ...
                  } text-sm flex space-x-3 items-center transition-all duration-150 cursor-pointer gap-2`}
                >
                  <span
                    className={`${
                      activeMultiMenu
                  ...
                  <span className="flex-none">
                    <span
                      className={`menu-arrow transform transition-all duration-300 ${
                        activeMultiMenu === j ? " rotate-90" : "rotate-180"
                      }`}
                    >
