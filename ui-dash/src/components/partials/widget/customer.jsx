        ...
        {customers.map((item, i) => (
          ...
          >
            ...
            >
              ...
              />
              <span className="h-[27px] w-[27px] absolute left-0 bottom-0 rounded-full bg-[#FFC155] border border-white flex flex-col items-center justify-center text-white text-xs font-medium">
                {item.number}
              </span>
            </div>
          ...
          >
            ...
            >
              ...
              <img
                ...
                className="w-full h-full rounded-full"
              />
              <span className="h-4 w-4 absolute left-0 bottom-0 rounded-full bg-[#FFC155] border border-white flex flex-col items-center justify-center text-white text-[10px] font-medium">
                {item.number}
              </span>
            </div>
