    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="lg:col-span-4 col-span-12">
          <Card title="نظرات" headerslot={<SelectMonth />}>
            <RadialsChart />
          </Card>
        </div>
        <div className="lg:col-span-8 col-span-12">
          <Card title="همه شرکت ها" headerslot={<SelectMonth />} noborder>
            <CompanyTable />
          </Card>
        </div>
        <div className="lg:col-span-4 col-span-12">
          <Card title="فعالیت اخیر" headerslot={<SelectMonth />}>
            <RecentActivity />
          </Card>
        </div>
        <div className="lg:col-span-8 col-span-12">
        ...
        <div className="lg:col-span-4 col-span-12">
          <Card title="مرور" headerslot={<SelectMonth />}>
            <RadarChart />
            <div className="bg-slate-50 dark:bg-slate-900 rounded p-4 mt-8 flex justify-between flex-wrap">
              ...
              <div className="space-y-1">
                <h4 className="text-slate-600 dark:text-slate-200 text-xs font-normal"></h4>
                <div className="text-sm font-medium text-slate-900 dark:text-white">
                  826435 تومان
                </div>
              </div>
