    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-5">
        ...
        <div className="2xl:col-span-4 lg:col-span-5 col-span-12">
          <Card title="آماری" headerslot={<SelectMonth />}>
        ...
        <div className="xl:col-span-6 col-span-12">
          <Card title="مشتری" headerslot={<SelectMonth />}>
            <Customer />
          </Card>
        </div>
        <div className="xl:col-span-6 col-span-12">
          <Card title="سفارشات اخیر" headerslot={<SelectMonth />} noborder>
            <RecentOrderTable />
          </Card>
        </div>
        <div className="xl:col-span-8 lg:col-span-7 col-span-12">
          <Card title="گزارش بازدیدکنندگان" headerslot={<SelectMonth />}>
            <BasicArea />
          </Card>
        </div>
        <div className="xl:col-span-4 lg:col-span-5 col-span-12">
          <Card
            title="بازدیدکنندگان بر اساس جنسیت"
        ...
        <div className="xl:col-span-6 col-span-12">
          <Card title="پرفروش ترین محصولات" headerslot={<SelectMonth />}>
            <Products />
          </Card>
        </div>
      </div>
