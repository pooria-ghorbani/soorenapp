  ...
  return (
    <div className="space-y-5">
      <div className="grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-5">
        ...
        >
          <div style={{ transform: "scaleX(-1)" }} s>
            <div className="max-w-[180px]">
              <h4 className="text-xl font-medium text-white mb-2">
                دش کد خود را ارتقا دهید
              </h4>
              <p className="text-sm text-white text-opacity-80">
                پلن ویژه برای نتیجه بهتر
              </p>
            </div>
        ...
        >
          <div style={{ transform: "scaleX(-1)" }}>
            <div className="max-w-[180px]">
              ...
              <p className="text-sm text-slate-800">پلن ویژه برای نتیجه بهتر</p>
            </div>
            <div className="absolute top-1/2 -translate-y-1/2 ltr:right-6 rtl:left-6 mt-2 h-12 w-12 bg-white rounded-full text-xs font-medium flex flex-col items-center justify-center">
              الان
            </div>
          ...
          <div className="flex-1">
            <div className="max-w-[180px]">
              <div className="text-xl font-medium text-slate-900 mb-2">
                ...
                <span className="block">آقای دیان راسل</span>
              </div>
        ...
        >
          <div className="flex-1">
            <div className="max-w-[180px]">
              ...
              <p className="text-sm text-white dark:text-slate-800 font-normal">
                به دشکد خوش آمدید
              </p>
            </div>
          </div>
          ...
          <div className="flex-1">
            <div className="max-w-[180px]">
              <h4 className="text-2xl font-medium text-white mb-2">
                <span className="block text-sm">موجودی,</span>
                <span className="block">تومان 34,564</span>
              </h4>
            </div>
          </div>
          <div className="flex-none">
          ...
          <div className="flex-1">
            <div className="max-w-[180px]">
              <h4 className="text-2xl font-medium text-slate-900 mb-2">
                ...
                <span className="block dark:text-slate-800">تومان 34,564</span>
              </h4>
            </div>
          </div>
          <div className="flex-none">
        ...
        {rabitWidget.map((item, i) => (
          ...
          >
            <div className="max-w-[168px]">
              <div className="widget-title">دسترسی نامحدود</div>
              <div className="text-xs font-normal">
                ارتقاء سیستم خود را به طرح کسب و کار انجام دهید.
              </div>
            </div>
