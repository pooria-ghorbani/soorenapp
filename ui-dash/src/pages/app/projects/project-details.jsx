  ...
  return (
    <div className=" space-y-5">
      <div className="grid grid-cols-12 gap-5">
        ...
        >
          <div>
            ...
            <p className="text-sm text-slate-600 dark:text-slate-300">
              متن تستی طولانی متن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن
              تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی
              طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی
              طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی
              طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی
              طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن تستی
              طولانیمتن تستی طولانی
            </p>
            <br />
            <p className="text-sm text-slate-600 dark:text-slate-300">
              متن تستی طولانی متن تستی طولانیمتن تستی طولانیمتن تستی طولانیمتن
        ...
        <Card title="یادداشت ها" className="xl:col-span-4 col-span-12">
      ...
      <div className="grid xl:grid-cols-3 grid-cols-1 gap-5">
        <Card title="لیست وظایف" headerslot={<SelectMonth />}>
          <TaskLists />
        </Card>
        <Card title="پیام ها" headerslot={<SelectMonth />}>
          <MessageList />
        </Card>
        <Card title="فعالیت" headerslot={<SelectMonth />}>
          <TrackingParcel />
        </Card>
      </div>
      <div className="grid grid-cols-12 gap-5">
        <div className="xl:col-span-8 lg:col-span-7 col-span-12">
          <Card title="اعضای تیم" noborder>
            <TeamTable />
          </Card>
        </div>
        <div className="xl:col-span-4 lg:col-span-5 col-span-12">
          <Card title="فایل ها" headerslot={<SelectMonth />}>
            <ul className="divide-y divide-slate-100 dark:divide-slate-700">
              {files.map((item, i) => (
