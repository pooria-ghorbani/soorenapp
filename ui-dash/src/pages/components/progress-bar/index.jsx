...
const ProgressbarPage = () => {
  return (
    <div className="grid xl:grid-cols-2 grid-cols-1 gap-5">
      ...
      <Card title="مثال اندازه">
        <div className="space-y-4">
          <ProgressBar value={30} title="پیشرفت sm" />
          <ProgressBar
            value={50}
            title="پیشرفت md"
      ...
      <Card title="نمونه‌های نوار پیشرفت مراحل">
        <Step />
      </Card>
    </div>
  );
